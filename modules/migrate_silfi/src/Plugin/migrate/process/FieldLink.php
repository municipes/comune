...
class FieldLink extends ProcessPluginBase {
  ...
  public function __construct(array $configuration, $plugin_id, $plugin_definition, MigrationInterface $migration) {
    ...
    $configuration += ['default_title' => ''];
    $configuration += ['force_title' => FALSE];
  ...
  public function transform($value, MigrateExecutableInterface $migrate_executable, Row $row, $destination_property) {
    $attributes = isset($value['attributes']) ?? unserialize($value['attributes']);
    ...
    $value['title'] = isset($value['title']) ? $value['title'] : $this->configuration['default_title'];
