...
namespace Drupal\silfi_log\ProxyClass;

use Drupal\Core\DependencyInjection\DependencySerializationTrait;
use Drupal\silfi_log\LogFileManager as RealLogFileManager;
use Drupal\silfi_log\LogFileManagerInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a proxy class for \Drupal\silfi_log\LogFileManager.
 *
...
class LogFileManager implements LogFileManagerInterface {
   ...
   *
   * @var \Drupal\silfi_log\LogFileManager
   */
  ...
  protected function lazyLoadItself(): LogFileManagerInterface {
    if (!isset($this->service)) {
      /** @var \Drupal\silfi_log\LogFileManager $service */
